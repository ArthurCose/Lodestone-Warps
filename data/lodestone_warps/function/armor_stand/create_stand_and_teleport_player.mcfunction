...
execute store success score $warp_valid lodestone_w run data get storage lodestone_warps:temp target.pos
...
execute if score $warp_valid lodestone_w matches 1 as @e[tag=lodestone_teleporter,limit=1] run function lodestone_warps:armor_stand/try_teleport
