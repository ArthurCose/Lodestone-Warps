...
execute store result score $attempting_teleport lodestone_w if score @s lodestone_w_s matches 1.. if data entity @s SelectedItem.components.minecraft:lodestone_tracker.target
